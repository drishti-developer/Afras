...
class fleet_report(osv.osv_memory):
    _name = "fleet.report"
...
#         'level':fields.integer('Level'),
        ...
        'cost_analytic_ids' : fields.many2many('account.analytic.account','rel_report_analytic_id1',
                                                'report_id1', 'analytic_id1',  'Cost Center', ) ,
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        res = super(fleet_report, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=False)
    ...
    def check_report(self, cr, uid, ids, context=None):
        ...
        for field in ['fiscalyear_id', 'chart_account_id', 'period_from', 'period_to', 'car_id', 'branch_id', 'city_id', 'region_id', 'country_id', 'area_id','cost_analytic_ids']:
